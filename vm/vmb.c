...
int run() {
  while(1) {
    ...
    if (opcode == 19) {
      ...
      pc = ARG(pc+1) ? ARG(pc+2) : pc + 3;
    } else if (opcode == 8) {
      pc = !ARG(pc+1) ? ARG(pc+2) : pc + 3;
    } else if (opcode == 1) {
      SET_REG(pc + 1, ARG(pc + 2));
      pc += 3;
    } else if (opcode == 9) {
      SET_REG(pc + 1, (ARG(pc+2) + ARG(pc+3))%32768);
      pc += 4;
    } else if (opcode == 4) {
      SET_REG(pc + 1, ARG(pc + 2) == ARG(pc + 3));
      pc += 4;
    } else if (opcode == 2) {
      stack[sp++] = ARG(pc + 1);
      pc += 2;
      ...
      SET_REG(pc + 1, ARG(pc +2)^0x7FFF);
      pc += 3;
    } else if (opcode == 17) {
      stack[sp++] = pc+2;
      pc = ARG(pc+1);
    } else if (opcode == 15) {
      SET_REG(pc + 1, mem[ARG(pc+2)]);
      pc +=3;
    } else if (opcode == 16) {
      mem[ARG(pc+1)] = ARG(pc+2);
      pc +=3;
    } else if (opcode == 18) {
      if (!sp) break;
      sp--;
